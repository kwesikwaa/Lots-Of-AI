  ...
  return (
    <View className="flex flex-col p-1 h-full w-full justify-between">
      ...
      <View className="flex flex-row justify-center space-x-4 mb-10 ">
        ...
        <TouchableOpacity className=" w-20 h-20 bg-purple-600 rounded-full flex items-center justify-center"><Text className="text-white">photo</Text></TouchableOpacity>
      </View>
    </View>
  )
}